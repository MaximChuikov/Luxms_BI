...
export interface ICalendarProps extends IDatePickerProps {
  className?: string;
...
export class Calendar extends React.Component<ICalendarProps> {
  public render() {
    const {p, formatTitle, className} = this.props;
    return (
      <Popup className={cn('Calendar', className)}>
        <div className="Calendar__Title">
          <input className="Calendar__Input" readOnly autoComplete="off" type="text" disabled={true} value={formatTitle ? formatTitle(p) : p} onMouseDown={(e: any) => e.preventDefault()}/>
